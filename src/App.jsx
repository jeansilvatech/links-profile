...
import {LinkedinLogo, InstagramLogo, GithubLogo, Globe, BehanceLogo} from "@phosphor-icons/react"
function App() {
  ...
  return (
    <div className='container'>
     ...
     <Button href="https://www.behance.net/jeansilvatech" name="Behance"icon={<BehanceLogo size={32} />}/>
